...
class Settings
{
    ...
    public function setAddNameDays(bool $addNameDays): static
    {
    ...
    public function setAddGenders(bool $addGenders): static
    {
    ...
    public function setAddSalutations(bool $addSalutations): static
    {
    ...
    public function setPreserveUnSubscribed(bool $preserveUnSubscribed): static
    {
    ...
    public function setSkipInvalidEmails(bool $skipInvalidEmails): static
    {
    ...
    public function setDoubleOptInSettings(?DoubleOptInSettings $doubleOptInSettings): static
    {
