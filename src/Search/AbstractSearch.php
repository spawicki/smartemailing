...
namespace App\Services\SmartEmailing\Api\src\Search;
...
abstract class AbstractSearch implements JsonSerializable, Stringable
{
    ...
    protected const int MAX_LIMIT = 500;

    protected const string TYPE_SELECT = 'select';
    protected const string TYPE_FILTER = 'filter';
    protected const string TYPE_EXPAND = 'expand';
    protected const string TYPE_SORT = 'sort';
    protected const string TYPE_ACTION_TYPE = 'type';
    protected const string TYPE_LIMIT = 'limit';
    protected const string TYPE_OFFSET = 'offset';
    protected const string SORT_DESC_INDEX = '-';
